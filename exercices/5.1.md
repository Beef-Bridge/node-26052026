# Exercice 5.1 : moteur de *template*
...
1. Générez un nouveau projet avec ***Express CLI*** avec le moteur de template de votre choix ***pug*** ou ***ejs***. Votre application tourne sur le ***port 8051***.
